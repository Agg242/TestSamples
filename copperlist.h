...
#define COP_WAIT(VPos, HPos, VMask, HMask, BlitF) (UBYTE)(VPos)<<8 | (UBYTE)(HPos) | 1, (UBYTE)((VMask & (~0x80)) | (((BlitF) & 0x1) << 7))<<8 | (UBYTE)(HMask) & (UBYTE)(~0x0001)
#define COP_WAIT_END 0xffff, 0xfffe
#define COP_SKIP(VPos, HPos, VMask, HMask, BlitF) (UBYTE)(VPos)<<8 | (UBYTE)(HPos) | 1, (UBYTE)((VMask & (~0x80)) | (((BlitF) & 0x1) << 7))<<8 | (UBYTE)(HMask) | (UBYTE)0x0001
